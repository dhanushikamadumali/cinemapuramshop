...
function init() {
    $(".kanban-items,.project-task tbody,.todo-task1 tbody").sortable({ connectWith: ".kanban-items,.project-task tbody,.todo-task1 tbody", stack: ".kanban-items  ul,.project-task tbody,.todo-task1 tbody" }).disableSelection(),
        $(".kanban-container,.todo-task2 tbody").sortable({ connectWith: ".kanban-container,.todo-task2 tbody ", stack: ".kanban-container,.todo-task2 tbody" }).disableSelection();
}
[].forEach.call(cols, addDnDHandlers), $(init);
//$(function () {
   // $(".adv-table").footable({ filtering: { enabled: !0 }, paging: { enabled: !0, current: 1 }, strings: { enabled: !1 }, filtering: { enabled: !0 }, components: { filtering: FooTable.MyFiltering } });
//}),
    ...
    //         this._super();
    //         var t = this,
    //             e = $("<div/>", { class: "form-group atbd-select d-flex align-items-center adv-table-searchs__position my-md-25 my-15 mr-sm-20 mr-0 " })
    //                 .append($("<label/>", { class: "d-flex align-items-center mb-sm-0 mb-2", text: "position" }))
    //                 .prependTo(t.$form);
    //         (t.$status = $("<select/>", { class: "form-control ml-sm-10 ml-0" })
    ...
    //             });
    //         var s = $("<div/>", { class: "form-group atbd-select d-flex align-items-center adv-table-searchs__status my-md-25 mt-15 mb-0 mr-sm-30 mr-0" })
    //             .append($("<label/>", { class: "d-flex align-items-center mb-sm-0 mb-2", text: "Status" }))
    //             .prependTo(t.$form);
    //         (t.$jobTitle = $("<select/>", { class: "form-control ml-sm-10 ml-0" })
    //             .on("change", { self: t }, t._onJobTitleDropdownChanged)
    //             .append($("<option/>", { text: t.jobTitleDefault }))
    //             .appendTo(s)),
    ...
    //         var e = t.data.self,
    //             s = $(this).val();
    //         s !== e.statusDefault ? e.addFilter("position", s, ["position"]) : e.removeFilter("position"), e.filter();
    //     },
    //     _onJobTitleDropdownChanged: function (t) {
    //         var e = t.data.self,
    //             s = $(this).val();
    //         s !== e.jobTitleDefault ? e.addFilter("status", s, ["status"]) : e.removeFilter("status"), e.filter();
    //     },
    //     draw: function () {
    //         this._super();
    //         var t = this.find("position");
...
!(function (t) {
    ...
    let e = {
            id: 1,
            events: [
                { id: "1", start: moment().format("YYYY-MM-17") + "T08:30:00", title: "Family Events" },
                { id: "2", start: moment().format("YYYY-MM-DD") + "T10:30:00", end: moment().format("YYYY-MM-DD") + "T12:00:00", title: "Dinner with Family" },
            ],
            className: "primary",
            textColor: "#5F63F2",
        },
        n = { id: 2, events: [{ id: "1", start: moment().format("YYYY-MM-20") + "T01:00:00", title: "Product Lunch" }], className: "secondary", textColor: "#FF69A5" },
        a = { id: 3, events: [{ id: "1", start: moment().format("YYYY-MM-DD") + "T18:30:00", title: "Team Meeting" }], className: "success", textColor: "#20C997" },
        i = {
            id: 4,
            events: [
                { id: "1", start: moment().format("YYYY-MM-25") + "T11:00:00", title: "Team Meeting" },
                { id: "2", start: moment().format("YYYY-MM-DD") + "T07:00:00", end: moment().format("YYYY-MM-DD") + "T08:30:00", title: "StrikingDash Calendar App" },
            ],
            className: "warning",
            textColor: "#FA8B0C",
        };
...
!(function () {
    "use strict";
    function e(e, t, l, r, o) {
        var s = new google.maps.LatLng(t, l),
            y = { center: s, zoom: 13, scrollwheel: !1, styles: r },
            a = new google.maps.Map(document.getElementById(e), y);
        new google.maps.Marker({ position: s, icon: o || "img/markar-icon.png" }).setMap(a);
    }
    $(".google-map").length &&
        google.maps.event.addDomListener(window, "load", function () {
            $("#google-map-basic").length && e("google-map-basic", 50.797897, -1.077641);
            $("#google-map-light").length &&
                e("google-map-light", 50.797897, -1.077641, [
            ...
            $("#google-map-dark").length &&
                e("google-map-dark", 50.797897, -1.077641, [
                    { featureType: "all", elementType: "labels.text.fill", stylers: [{ color: "#ffffff" }] },
                    { featureType: "all", elementType: "labels.text.stroke", stylers: [{ visibility: "on" }, { color: "#424b5b" }, { weight: 2 }, { gamma: "1" }] },
                    { featureType: "all", elementType: "labels.icon", stylers: [{ visibility: "off" }] },
                    { featureType: "administrative", elementType: "geometry", stylers: [{ weight: 0.6 }, { color: "#545b6b" }, { gamma: "0" }] },
                    { featureType: "landscape", elementType: "geometry", stylers: [{ color: "#545b6b" }, { gamma: "1" }, { weight: "10" }] },
                    { featureType: "poi", elementType: "geometry", stylers: [{ color: "#666c7b" }] },
                    { featureType: "poi.park", elementType: "geometry", stylers: [{ color: "#545b6b" }] },
                    { featureType: "road", elementType: "geometry", stylers: [{ color: "#424a5b" }, { lightness: "0" }] },
                    { featureType: "transit", elementType: "geometry", stylers: [{ color: "#666c7b" }] },
                    { featureType: "water", elementType: "geometry", stylers: [{ color: "#2e3546" }] },
                ]);
            $("#google-map-theme").length &&
                e("google-map-theme", 50.797897, -1.077641, [
                    { featureType: "all", elementType: "labels.text.fill", stylers: [{ color: "#ffffff" }] },
                    { featureType: "all", elementType: "labels.text.stroke", stylers: [{ visibility: "on" }, { color: "#424b5b" }, { weight: 2 }, { gamma: "1" }] },
                    { featureType: "all", elementType: "labels.icon", stylers: [{ visibility: "off" }] },
                    { featureType: "administrative", elementType: "geometry", stylers: [{ weight: 0.6 }, { color: "#fff" }, { gamma: "0" }] },
                    { featureType: "landscape", elementType: "geometry", stylers: [{ color: "#5F63F2" }, { gamma: "1" }, { weight: "10" }] },
                    { featureType: "poi", elementType: "geometry", stylers: [{ color: "#5F63F290" }] },
                    { featureType: "poi.park", elementType: "geometry", stylers: [{ color: "green" }] },
                    { featureType: "road", elementType: "geometry", stylers: [{ color: "green" }, { lightness: "0" }] },
                    { featureType: "transit", elementType: "geometry", stylers: [{ color: "#666c7b" }] },
                    { featureType: "water", elementType: "geometry", stylers: [{ color: "#ffffff" }] },
                ]);
        });
})();
$.getJSON("json/icons.json", function (n) {
    const { faIcons: s } = n,
        { laIcons: a } = n,
        c = n.featherIcons,
        l = s.map((n) => `\n                <div class="col-sm-6 col-md-4 col-lg-3">\n                    <i class="fas fa-${n}"></i>\n                    <span class="icon-text">${n}</span>\n                </div>\n            `),
        o = a.map((n) => `\n                <div class="col-sm-6 col-md-4 col-lg-3">\n                    <i class="la la-${n}"></i>\n                    <span class="icon-text">${n}</span>\n                </div>\n            `);
    $(".faIcon-list-box").append(l), $(".laIcon-list-box").append(o);
    const i = c.map((n) => `\n                <div class="col-sm-6 col-md-4 col-lg-3">\n                    <span data-feather="${n}"></span>\n                    <span class="icon-text">${n}</span>\n                </div>\n            `);
    $(".feIcon-list-box").append(i), feather.replace();
});
const regionMap = document.getElementById("region-map"),
    regionMapW = document.getElementById("region-map_W"),
    regionMapM = document.getElementById("region-map_M"),
    regionMapY = document.getElementById("region-map_Y"),
    s_regionMapT = document.getElementById("s_region-map_T"),
    s_regionMapW = document.getElementById("s_region-map_W"),
    s_regionMapM = document.getElementById("s_region-map_M"),
    s_regionMapY = document.getElementById("s_region-map_Y"),
...
$("#sb_location-month-tab").on("shown.bs.tab", function () {
    $(regionMapM).vectorMap({
        ...
        hoverOpacity: 0.8,
        regionStyle: { initial: { fill: "#E3E6EF" }, hover: { fill: "#5F63F2", "fill-opacity": 1 } },
        markerStyle: { initial: { fill: "#5F63F215", stroke: "#5F63F2", "stroke-width": 4 } },
        markers: [
        ...
        series: { regions: [{ scale: ["#C8EEFF", "#0071A4"] }] },
    }),
...
!(function (t) {
    const e = document.getElementById("leaflet-basic"),
        a = document.getElementById("leaflet-multiIcon"),
        i = document.getElementById("leaflet-customIcon"),
        r = document.getElementById("leaflet-cluster");
    if (e) {
        var o = L.map(e).setView([51.505, -0.09], 13);
        ...
        var s = L.marker([51.5, -0.09]).addTo(o);
    }
    if (a) {
        var m = L.map("leaflet-multiIcon").setView([51.505, -0.09], 13);
        L.tileLayer("https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw", {
            maxZoom: 30,
            attribution:
                'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery Â© <a href="https://www.mapbox.com/">Mapbox</a>',
        ...
        let t = L.marker([51.509, -0.08]).bindPopup("This is Littleton, CO."),
            e = L.marker([51.503, -0.06]).bindPopup("This is Littleton, CO."),
            a = L.marker([51.51, -0.09]).bindPopup("This is Littleton, CO.");
        L.layerGroup([t, e, a]).addTo(m);
    }
    if (i) {
        var p = L.map("leaflet-customIcon").setView([51.505, -0.09], 13);
        L.tileLayer("https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw", {
            maxZoom: 30,
            attribution:
                'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery Â© <a href="https://www.mapbox.com/">Mapbox</a>',
        ...
        var n = L.icon({ iconUrl: "../img/svg/clock.svg", iconSize: [38, 95] });
        s = L.marker([51.5, -0.09], { icon: n }).addTo(p);
    }
    if (r) {
        let t = [
            ...
            e = L.map("leaflet-cluster").setView([-37.82, 175.23], 13);
        L.tileLayer("https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw", {
            attribution:
                'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors, <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, Imagery Â© <a href="https://www.mapbox.com/">Mapbox</a>',
            id: "mapbox/streets-v11",
        ...
        for (var c = L.markerClusterGroup(), l = 0; l < t.length; l++) {
            var h = (o = t[l])[2];
            (s = L.marker(new L.LatLng(o[0], o[1]), { title: h })).bindPopup(h), c.addLayer(s);
        }
        e.addLayer(c);
    }
})(jQuery);
!(function (e) {
    ...
    x &&
        ...
        e(".select-alerts2").select2({ placeholder: "Select a Product", dropdownCssClass: "alert2", allowClear: !0 }),
