...
class Report extends CI_Controller {
	...
	public function sales_report()
	{
		...
		$this->load->view('report/1stall_product_sales_report');
		$this->load->view('template/footer');
	}

    //All Stall Sales Report
	public function stole_sales_report()
	{
		$this->load->view('template/header');
		$this->load->view('report/2stole_sales_report');
		$this->load->view('template/footer');
	}
	...
	{
		$this->load->view('template/header');
		$this->load->view('report/3sales_weekly');
		$this->load->view('template/footer');
	}
	...
	{
		$this->load->view('report/3sales_weekly_report');
	}
	  
	public function sales_dailly()
	{
		$this->load->view('template/header');
		$this->load->view('report/4sales_dailly');
		$this->load->view('template/footer');
	}
	
	public function salesdailly()
	{
		$this->load->view('report/4sales_dailly_report');
	}
	
	public function daily_stall_report()
	{
		$this->load->view('template/header');
		$this->load->view('report/5stall_report.php');
		$this->load->view('template/footer');
	}
	
	public function stall_item_date_report()
	{
		$this->load->view('template/header');
		$this->load->view('report/6stall_item_date');
		$this->load->view('template/footer');
	}
	public function stallitemdate()
	{
		$this->load->view('report/6stall_item_date_report');
	}
	...
	{
		$this->load->view('template/header');
		$this->load->view('report/7service_charge');
		$this->load->view('template/footer');
	}
	
	public function stall_daterange()
	{
		$this->load->view('template/header');
		$this->load->view('report/8stall_daterange_report');
		$this->load->view('template/footer');
	}
...
public function employee_attendance()
	{
		$this->load->view('template/header');
		$this->load->view('report/9employee_attendance_report');
		$this->load->view('template/footer');
	}
