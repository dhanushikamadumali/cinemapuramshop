                            ...
                            <?= form_open_multipart("", array("id" => "inForm")); ?>
                                    <div class="row">
                                        <div class="col-md-6 mb-25">
                                            <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Supplier Name" name="sname" >
...
<script type="text/javascript">
 ...
 $(".save_btn").click(function (e) {
    ...
    function add_form($form) { 
        ...
        formdata.append("func_n","ad_supplier");
        $.ajax({
            type: "post",
            dataType: "JSON",
            ...
            success: function (data) {
                ...
                if(data.status==false){
                    ...
                    setTimeout(function(){ window.location.href="<?php echo base_url()?>index.php/supplier";  });
                }
            }
        });
    }
