                                        ...
                                        <table  class="table mb-0 table-borderless adv-table example" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                            <thead>
                                                <tr class="userDatatable-header">
                                                    ...
                                                    <th >
                                                        <span class="userDatatable-title">tno</span>
                                                    </th>
                                                    <!-- <th>
                                            ...
                                            $employee = $this->Common_model->get_all('employee')->result();
                                            if ($employee):
                                                foreach ($employee as $information):  
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                            ...
                                                            <li>
                                                                <a href='<?php echo base_url(); ?>index.php/Employee/Edit?id=<?php echo $information->id; ?>' class="edit">
...
<script type="text/javascript">
    ...
    $("body").on("click",".deactive",function(){
        ...
        text: "Are you sure you want to deactive employee now !",
        icon: "warning",
        buttons: true,
        dangerMode: true,
        })
        ...
        if (willDelete) {
            $.ajax({
                url: "<?php echo base_url(); ?>index.php/Employee/ajax",
                type:'POST',
                data: {
                "eid": $(this).val(),
                "func_n":"deactiveemployee"
                }, 
  ...
  $("body").on("click",".active",function(){
    ...
    text: "Are you sure you want to active employee now !",
    icon: "warning",
    buttons: true,
    dangerMode: true,
    })
