...
<script type="text/javascript">
		...
		var table = $(".example").DataTable( {
			...
			"ajax": {
				"url": "<?= base_url(); ?>index.php/Payment/purchase_payment_ajax",
				"type": "POST",
				// data:{
			...
			columns: [
                    ...
                    {"data": "dtb_paynodkr",className: "dtb_paynodkr" ,
                    ...
                    {"data": "dtb_paytype",className: "dtb_paytype" ,
					"render": function(data, type, full, meta) {
						if(data == "" || data == null){
							return "-";
						}else{
                    ...
                    {"data": "dtb_paytot",className: "dtb_paytot" ,
					"render": function(data, type, full, meta) {
						if(data == "" || data == null){
							return "-";
						}else{
