        ...
        <div class="col-lg-12">
                        <div class="card card-Vertical card-default card-md mb-4">
                            <div class="card-header">
                                <h6>Add Manufature </h6>
                            </div>
                            <div class="card-body py-md-30">
                            <?= form_open_multipart("", array("id" => "inForm")); ?>
                                    <div class="row">
                                        <div class="col-md-6 mb-25">
                                            <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Manufature name" name="mname" > 
                                            <span class="err err_mname required" style="font-size:10px; color: #F5576C !important" ></span>
                                        </div>
                                        <div class="col-md-6 mb-25">
                                            <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Manufature Order" name="morder" > 
                                        ...
                                        <div class="col-md-6 mb-25">
                                         ...
                                         <div class="col-md-6 mb-25">
                                            <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Commission" name="commission" > 
...
<script type="text/javascript">
 ...
 $(".save_btn").click(function (e) {
    ...
    function add_form($form) { 
        ...
        formdata.append("func_n","ad_manu");
        $.ajax({
            type: "post",
            dataType: "JSON",
            ...
            success: function (data) {
                ...
                if(data.status==false){
                    ...
                    $(".err_commission").html(data.commission);
                  ...
                  window.location.href="<?php echo base_url()?>index.php/product/add_manu"; 
                }
            }
        });
    }
