                                        ...
                                        <table class="table mb-0 table-borderless adv-table example" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                            <thead>
                                                <tr class="userDatatable-header">
                                                    <th>
                                                        <span class="userDatatable-title">manufature id</span>
                                                    </th>
                                                    <th>
                                                    ...
                                                    <th>
                                                        <span class="userDatatable-title">Comission</span>
                                                    </th>
                                            ...
                                            $manufa = $this->Common_model->get_all('manufacturer_information')->result();
                                            if ($manufa):
                                                foreach ($manufa as $information):  
                                            ?>
                                                <tr>
                                                    <td>
                                                        <div class="userDatatable-content"><?= $information->manufacturer_id ?></div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="userDatatable-inline-title">
                                                                <a href="#" class="text-dark fw-500">
                                                                    <h6> <?= $information->	manufacturer_name ?></h6>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                            <li>
                                                                <a href='<?php echo base_url(); ?>index.php/Product/manuEdit?id=<?php echo $information->id; ?>' class="edit">
