...
<script type="text/javascript">
        ...
        var table = $(".example").DataTable( {
            ...
            "ajax": {
                "url": "<?= base_url(); ?>index.php/Sales/today_sales_ajax",
                "type": "POST",
                // data:{
