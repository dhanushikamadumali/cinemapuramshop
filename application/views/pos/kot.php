...
$this->db->select('*'); 
$manudetails = $this->Common_model->get_all('manufacturer_information',['manufacturer_information.id'=> $this->input->get('stall_id')])->result(); 
    $items=0;
    $itemqty=0;
    $ttlprice=0;
    $ttldisco=0;
    ...
    $sales_order_details = $this->Common_model->get_all('sales_order_details',['sales_order_details.order_id'=> $this->input->get('id'),'product_information.manufacturer_id'=> $this->input->get('stall_id')])->result();
     ?>
     <div class="container-fluid" style="padding:0px">
    <div class="row">
       <div class="" style="width: 300px">
                <div  style="font-weight: 600;font-size:16px;text-align:center">
               <?php echo  $manudetails[0]->manufacturer_id. " ".$manudetails[0]->manufacturer_name; ?>
                </div>
                ...
                <div class="row">
                    ...
                    <div style="width:60%;"><?=  $sales_order[0]->transaction_no  ?></div>
                        ...
                        <thead>
                            <tr>
                                ...
                                if($sales_order[0]->order_type=="dine-in"): 
                                      ...
                                      ?> 
                                       <td style="font-size: 13px;font-weight:600;padding:0px 4px;text-align:right">PK Chrarge</td> 
                                    <?php
                                    endif;
                                ?> 
                                ...
                                <td style="text-align:right;padding:0px 4px"><?= number_format($sadetails->per_price,0,"","") ?></td>
                                 <?php
                                    if($sales_order[0]->order_type=="dine-in"): 
                                          ...
                                          ?> 
                                            <td style="text-align:right;padding:0px 4px"> <?= number_format($sadetails->packaging_charge ,0,".",",") ?></td> 
                                        <?php
                                        endif;
                                    ?> 
                                <td style="text-align:right;padding:0px 4px"><?= number_format($sadetails->total_price+$sadetails->packaging_charge,0,"",""); $ttlprice+= $sadetails->packaging_charge+$sadetails->total_price; ?></td>
                            </tr>
                            <?php
                            endforeach;
                            ?>
