                                ...
                                <?= form_open_multipart("", array("id" => "inForm")); ?>
                                    <div class="row">
                                        ...
                                        if( $details ):
                                            ...
                                            <input type="checkbox" class="custom-control-input isshop" id="editch" name="qty"  value="<?php echo $this->session->userdata("manufaturer_id")?>" checked>
                                        ...
                                        <?php if($details[0]->shop_status=="0") {?>
                                            <div class="custom-control custom-switch switch-primary switch-md "> 
                                            <input type="checkbox" class="custom-control-input isshop" id="editch" name="qty"  value="<?php echo $this->session->userdata("manufaturer_id")?>" >
                                            <label class="custom-control-label " for="editch"> </label>
