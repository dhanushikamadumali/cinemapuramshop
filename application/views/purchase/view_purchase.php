                                    ...
                                    <table class="table mb-0 table-borderless adv-table example" data-sorting="true" data-filter-container="#filter-form-container" data-paging-current="1" data-paging-position="right" data-paging-size="10">
                                        <thead>
                                            <tr class="userDatatable-header">
                                                ...
                                                <th>
                                                    <span class="userDatatable-title">branch name</span>
                                                </th>
                                                <th>
...
<script type="text/javascript">
    ...
    var table = $(".example").DataTable({
        ...
        "ajax": {
            "url": "<?= base_url(); ?>index.php/Purchase/view_purchase_ajax",
            "type": "POST",
            // data:{
        ...
        columns: [
            ...
            {"data": "dtb_purnodkr", className: "dtb_purnodkr",
            ...
            {"data": "dtb_branchid", className: "dtb_branchid",
                "render": function (data, type, full, meta) {
                    if (data == "" || data == null) {
                        return "-";
                    } else {
            ...
            {"data": "dtb_purdis", className: "dtb_purdis",
                "render": function (data, type, full, meta) {
                    if (data == "" || data == null) {
                        return "-";
                    } else {
            ...
            {"data": "dtb_purtot", className: "dtb_purtot",
                "render": function (data, type, full, meta) {
                    if (data == "" || data == null) {
                        return "-";
                    } else {
            ...
            {"data": "renival_igGrt", className: "renival_igGrt",
                "render": function (data, type, full, meta) {
                    return ' <ul class="orderDatatable_actions mb-0 d-flex flex-wrap"><li> <i class="fa fa-eye view_purchase" id="'+ data + '"></i> </li> </ul> '; // <li><a  href="<?= base_url() ?>index.php/Purchase/Edit?id='+data+'"   class="edit"><span class="far fa-edit"></span></a></li><li><a href="#" class="remove"><span class="far fa-trash-alt"></span></a></li>
                }},
        ],
    ...
    $("body").on("click", ".view_purchase", function (e) {
        alert();
        e.preventDefault();
        $.ajax({
            type: "post",
