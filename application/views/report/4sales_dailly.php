        ...
        <div class="col-lg-12">
                        <div class="card card-Vertical card-default card-md mb-4">
                            <div class="card-header">
                                <h6>Sales dailly Report</h6>
                            </div>
                            <div class="card-body py-md-30">
                         
                                <?= form_open( base_url()."index.php/report/salesdailly", array('method'=>'get',"id" => "inForm")); ?>
                                    <div class="row">
                                       
                                        <!-- <div class="col-md-3 mb-25">
                                          
                                        <input type="date" class="form-control monthyear" id="FromDate" name="FromDate">
                                        ...
                                        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                            ...
                                            <div class="checkbox-theme-default custom-checkbox" style="padding:10px 0px">
                                                <input class="checkbox checkval" type="checkbox" id="check-un1" name="withitem">
...
<script type="text/javascript">
    ...
    $("body").on('click', '.save_btn', function () { 
       var chk=($(".checkval").is(':checked'))?"1":"0"; 
        document.body.innerHTML += '<form id="dynForm" action="<?php echo base_url(); ?>index.php/report/sales_dailly_report" method="post"><input type="hidden" name="fromdate" value="'+ $(".fromdate").val()+'"><input type="hidden" name="todate" value="'+ $(".todate").val()+'"><input type="hidden" name="withitem" value="'+chk+'"></form>';
