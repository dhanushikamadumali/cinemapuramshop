                            ...
                            <div class="card-body py-md-30">
                                ...
                                <?= form_open_multipart("", array("id" => "inForm")); ?>
                                    <div class="row">
                                        ...
                                        <input type="month" class="form-control monthyear" id="FromDate" name="FromDate">
...
<script type="text/javascript">
      ...
      $("body").on('click', '.save_btn', function () {
        ...
        setTimeout(function () {
                window.location.href = "<?php echo base_url() ?>index.php/report/salesweekly?date=" +$(".monthyear").val();
            });
        ...
        //     type: "post",
        //     dataType: "JSON",
        //     url: "<?php echo base_url(); ?>index.php/report/sales_ajax",
        //     data: {
        //         func_n: "get_sales_weekly",
