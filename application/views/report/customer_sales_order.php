...
<script type="text/javascript">
		...
		var table = $(".example").DataTable( {
			...
			"ajax": {
				"url": "<?= base_url(); ?>index.php/Customer/customer_sales_order_datatable_ajax",
				"type": "POST",
				// data:{
			...
			columns: [
				...
				{"data": "dtb_salortranno",className: "dtb_salortranno" ,
                    ...
                    {"data": "dtb_cusNalsdkj",className: "dtb_cusNalsdkj" ,
					"render": function(data, type, full, meta) {
						if(data == "" || data == null){
							return "-";
						}else{
					...
					{"data": "dtb_salordisamount",className: "dtb_salordisamount" ,
					"render": function(data, type, full, meta) {
						if(data == "" || data == null){
							return "-";
						}else{
				...
				{"data": "dtb_salorcustpaid",className: "dtb_salorcustpaid" ,
					"render": function(data, type, full, meta) {
						if(data == "" || data == null){
							return "-";
						}else{
                    ...
                    {"data": "dtb_saleortoamount",className: "dtb_saleortoamount" ,
					"render": function(data, type, full, meta) {
						if(data == "" || data == null){
							return "-";
						}else{
                    ...
                    {"data": "dtb_saleorremark",className: "dtb_saleorremark" ,
					"render": function(data, type, full, meta) {
						if(data == "" || data == null){
							return "-";
						}else{
				...
				// 	"render": function(data, type, full, meta) {					
                //       return ' <ul class="orderDatatable_actions mb-0 d-flex flex-wrap"><li><a href="#" class="view"><span class="fa fa-eye"></span></a> </li>  <li><a  href="<?= base_url() ?>index.php/Customer/Edit?id='+data+'"   class="edit"><span class="far fa-edit"></span></a></li><li><a href="#" class="remove"><span class="far fa-trash-alt"></span></a></li></ul> ';
                //     } },
			],
