                            ...
                            <?= form_open_multipart("", array("id" => "inForm")); ?>
                                    <div class="row">
                                        <div class="col-md-6 mb-25">
                                            ...
                                            <select class="js-example-basic-single js-states form-control bank" name="bname">
                                                <option value="">Select Bank</option>
                                                <?php
                                                $this->db->select("id,bank_name");
                                                $bank = $this->Common_model->get_all("bank")->result();
                                                if ($bank):
                                                    foreach ($bank as $tableRes):
                                                        ?>
                                                        <option value="<?= $tableRes->id ?>"  > <?= $tableRes->bank_name ?></option>
                                                    <?php
                                                    endforeach;
                                                endif;
                                                ?>
                                        ...
                                        <div class="col-md-6 mb-25">
                                            <select class="js-example-basic-single js-states form-control bankbranch" name="bbranch">
                                        ...
                                        <div class="col-md-6 mb-25">
                                            <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Account Number" name="accno"> 
                                            <span class="err err_accno required" style="font-size:10px; color: #F5576C !important" ></span>
                                        </div>
                                        <div class="col-md-6">
...
<script type="text/javascript">
 ...
 $(".save_btn").click(function (e) {
    ...
    function add_form($form) { 
        ...
        formdata.append("func_n","ad_bcompany");
        $.ajax({
            type: "post",
            dataType: "JSON",
            url: "<?php echo base_url(); ?>index.php/bankcompany/bankcompany_ajax",
            data: formdata,
            cache: false,
            contentType: false,
            processData: false,
            success: function (data) {
                ...
                if(data.status==false){
                    ...
                    setTimeout(function(){ window.location.href="<?php echo base_url()?>index.php/bankcompany";  });
                }
    ...
    $('.bank').change(function(e){
        ...
        $.ajax({
            ...
            data: {
                "bank_id":$(this).val(),
                "func_n":"get_bank_branch"
                }, 
            success: function (data) {
                $(".bankbranch").empty();
                $(".bankbranch").append(data);
